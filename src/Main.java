...
public class Main {
    ...
    private static void teststringRotation() {
    	...
    	String result = RtsSolution.stringRotation("TESTRTSMYSTRING", 5);
    	System.out.println("Result for String 'TESTRTSMYSTRING' with rotation length 5 = "+result);
    	
    	String resultMoreThanLength = RtsSolution.stringRotation("TESTRTSMYSTRING", 20);
		...
		String resultNull = RtsSolution.stringRotation(null, 0);
		
		System.out.println("Result for String is NULL = " + resultNull);
		
		String resultEmptyString = RtsSolution.stringRotation("", 20);
	...
	private static void testAboveBelow() {
        ...
        Map<String,Integer> results = RtsSolution.aboveBelow(listWithSortedValue,5);
        ...
        Map<String,Integer> resultsUnSortedValue = RtsSolution.aboveBelow(listWithUnSortedValue,2);
        ...
        Map<String,Integer> resultsNull = RtsSolution.aboveBelow(listNull,5);
